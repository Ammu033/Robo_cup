...
#    while not rospy.get_param('modelLoaded'): time.sleep(0.01)
    ...
    p.exec_action('speak' , 'Hello_there,_welcome_to_the_University_of_Lincoln!')
    p.exec_action('speak', 'I_want_to_know_you_better,can_one_of_you_come_in_front_of_me_please?.')
