...
tmux send-keys -t ollama:0.4 C-z 'echo -e "\n\n\nExample to set intent:\nrostopic pub /planner_intention std_msgs/String \"guest_name\" -1\n"' Enter Enter
tmux send-keys -t ollama:0.3 C-z 'rostopic echo /ollama_response' Enter
tmux send-keys -t ollama:0.5 C-z 'rostopic echo /stt/listening' Enter
tmux send-keys -t ollama:0.2 C-z 'rostopic echo /ollama_output' Enter
